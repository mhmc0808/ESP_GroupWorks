...
# Next we create a function, plot_dynamics, to visualize the number of individuals in each SEIR compartment over time.
...
# Next we will compare four epidemic scenarios generated by the SEIR model.
...
# Lastly, we will plot each of the above epidemic scenarios using plot_dynamics
